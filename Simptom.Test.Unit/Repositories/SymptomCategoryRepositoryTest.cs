...
{
	[TestClass]
	public class SymptomCategoryRepositoryTest : ISymptomCategoryRepositoryTest
	{
		...
		public override void TestInitialize()
		{
			...
			this.repository = new SymptomCategoryRepository(this.connection.Object, this.modelFactory.Object);
		}
		...
		public override void AddRow(ISymptomCategory symptomCategory)
		{
			DataRow row = this.dataSet.Tables[0].NewRow();
			
			row["ID"] = symptomCategory.Key.ID;
			
			row["Name"] = symptomCategory.Name;
